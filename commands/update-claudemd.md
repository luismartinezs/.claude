...
description: Automatically update CLAUDE.md files based on recent code changes
---
...
Based on the current CLAUDE.md content and all the git analysis above, create updated CLAUDE.md files that:
...
- **Scoped CLAUDE.md files**: Modify the CLAUDE.md file at the right scope level
- **Mind the CHANGELOG.md**: Log recent changes in CHANGELOG.md, not in CLAUDE.md
