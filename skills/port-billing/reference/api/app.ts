...
import { billingApi, stripeWebhook } from "./domains/billing/api.ts"
...
// Registered before the same-origin guard: Stripe sends no Origin and is authenticated by signature.
